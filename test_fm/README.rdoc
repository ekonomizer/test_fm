...
rake db:fixtures:extract FIXTURES=foo,bar #export from db
rake db:fixtures:load FIXTURES=foo,bar #import to db
rake db:fixtures:load FIXTURES=cities,countries,clubs,leagues,universes
